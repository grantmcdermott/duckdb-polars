...
you.^[If you're unsure and jsut want to pick one, then I recommend R. It's much
...
```sh
python3 -m pip install -U duckdb polars pyarrow pandas
python3 -m pip install -U 'ibis-framework[duckdb,polars]'
```
