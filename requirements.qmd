...
We also have different install targets for **r-polars**, depending on your
...
install.packages("tidypolars", repos = "https://etiennebacher.r-universe.dev")
## Ubuntu
install.packages("polars", repos = "https://rpolars.r-universe.dev/bin/linux/jammy/4.4")
install.packages("tidypolars", repos = "https://etiennebacher.r-universe.dev/bin/linux/jammy/4.3")
```
