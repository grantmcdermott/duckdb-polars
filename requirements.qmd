...
cd duckdb-polars
```
(If you can't clone the repo for some reason, don't worry. It's not a train
smash. But you may need to adjust some relative file paths when you are calling
the actual code chunks later in the workshop. We'll figure it out.) 
:::
